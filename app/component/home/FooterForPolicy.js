...
const FooterForPolicy = () => {
  return (
    <div className="">
      <div className=" footer relative  "></div>
      <div className="grid  px-7 xl:px-22 gap-16 row-gap-10 mb-8 lg:grid-cols-6 items-center pt-7    ">
...
export default FooterForPolicy;
